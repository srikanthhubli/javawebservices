...
.andExpect(jsonPath("$.productDescription", is("OnePlus9Pro")))
...
.andExpect(jsonPath("$[0].productDescription", is("OnePlus9Pro")))
...
.andExpect(jsonPath("$[1].productDescription", is("OnePlus8Pro")))
...
.andExpect(jsonPath("$[2].productDescription", is("Iphone12")))
...
.andExpect(jsonPath("$.productid", is(50)))
.andExpect(jsonPath("$.productName", is("Oneplus")))
.andExpect(jsonPath("$.productDescription", is("OnePlus10Pro")))
.andExpect(jsonPath("$.price", is(70000.00)))
.andExpect(jsonPath("$.starRating", is(4.5)));
